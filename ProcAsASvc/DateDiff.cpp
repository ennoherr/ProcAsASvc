...
// https://www.codespeedy.com/find-difference-between-two-dates-in-cpp/

int CDateDiff::IsLeapYear(int year)
{
...
int CDateDiff::DaysOfMonth(int month, int year)
{
    // feb, calc leap year
    if (month == 2)
    {
...
long long int CDateDiff::DiffDays(int day1, int month1, int year1, int day2, int month2, int year2)
{
    if (year1 == year2)
    {
        if (month1 == month2)
    ...
    else if (year1 < year2)
    {
        ...
        if (month1 == month2)
        {
            if (day1 == day2)      //for same month, same day but diff year
                ...
                return temp + ((long long int)day2 - day1);
            else
                return temp - ((long long int)day1 - day2);
        }
        else if (month1 < month2)
        {
            ...
            {
                result = result + ((long long int)day2 - day1);
                return temp + result;
            }
            else
            {
                result = result - ((long long int)day1 - day2);
                return temp + result;
            }
        }
        else
